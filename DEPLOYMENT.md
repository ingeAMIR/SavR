...
2. *Settings → Environment Variables*: agrega las tres variables para **Production**,
   **Preview** y **Development**.
3. `NEXT_PUBLIC_SITE_URL` debe ser la URL final del deploy.
4. Vuelve a Supabase → *URL Configuration* y agrega la URL de producción (y el patrón
   de previews si vas a usarlas) a las *Redirect URLs*.
5. Si conectas un dominio propio, repite los pasos 3 y 4 con él.
